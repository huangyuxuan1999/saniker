  ...
  if($select)
  {
    if(isset($_POST["subl"]))
    {
      ...
      if($name==""||$password=="")//判断是否为空
      {
        ...
        echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."http://127.0.0.1/登入页面.html"."\""."</script>";
        exit;
      }
      ...
      {
        echo"登录成功！";
        echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."http://127.0.0.1/index1.php"."\""."</script>";
      }
      {  
