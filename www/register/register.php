<?php
$link=mysql_connect("127.0.0.1","root","root");//链接数据库
    ...
    if($select)
    {
      ...
      if(isset($_POST["sub"]))
      {
        ...
        if($name==""||$password1=="")//判断是否填写
        {
          ...
          echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."http://127.0.0.1/register/register.html"."\""."</script>";    
          exit;
        }
        ...
        if($close)
        {
          //echo"数据库关闭";
          //echo"注册成功！";
          echo"<script type="."\""."text/javascript"."\"".">"."window.location="."\""."http://127.0.0.1/register/return.html"."\""."</script>";    
        }
        }
        else
        {
